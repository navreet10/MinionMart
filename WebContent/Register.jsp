...
<div align="center">User Address:               <input type="text" name ="useraddress" id="useraddress" value=""></input>
</div>
<div align="center">User Email:          <input type="text" name ="useremail" id="useremail" value=""></input>
</div>
<div align="center">User Zipcode:           <input type="text" name ="userzipcode" id="userzipcode" value=""></input></div>
<br>
